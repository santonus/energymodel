...
def objective(trial, data_path: str, test_arch_idx: int):
    ...
    # Log results
    logger = ExperimentLogger(experiment_id=f'out_of_distribution_quant_neuralnet_arch{test_arch_idx}')
...
def main():
    ...
    print(f"\n{'='*60}")
    print("OUT-OF-DISTRIBUTION EXPERIMENT - QUANTILE NEURAL NETWORK")
