...
1. Go to Window->Show View->Other->Other->Energy Estimation Results. A custom console would appear, on which all results are displayed. Without this step, you won't be able to see any output generated by the plugin.
